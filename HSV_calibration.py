...
arduinoWriteRead("450 100")  # send motor delay params. safe = "450 100"
...
HSV_ranges = []
for HSVs in HSV_colours:
    lowest = tuple(map(max, zip(*arr)))
    highest = tuple(map(min, zip(*arr)))
    HSV_ranges.append((lowest, highest))
print("HSV ranges:")
print(*HSV_ranges, sep="\n")
